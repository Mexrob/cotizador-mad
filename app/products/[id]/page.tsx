              ...
              <div className="grid grid-cols-4 gap-2">
                {images.map((image, index) => (
                  <button
                    ...
                    className={`relative aspect-square overflow-hidden rounded-lg ${selectedImageIndex === index
          ...
          >
                      ...
                      <div className="space-y-2">
                        ...
                        <Link href="/auth/signin">
                          <Button
                            variant="ghost"
                            size="sm"
                            className="text-sm p-0 h-auto text-module-black hover:text-gray-800 hover:bg-transparent"
                          >
            ...
            {product.isCustomizable && product.basePrice && (
              <DimensionCalculator
                ...
                className="bg-gradient-to-br from-gray-50 to-indigo-50"
              />
            )}
